...
date: 2023-05-25
status: published
keywords: 'Command Menu, roadmap.sh, navigation tool, browsing experience, roadmaps, command menu astro, astrojs, preact, cmd+k, cmd+k astro and preact'
...
All of our roadmaps are stored in `/src/data/roadmaps/roadmap-name/roadmap-name.md`, and `/src/data/best-practices/best-practices-name/best-practices-name.md` for best practices. For example, the frontend roadmap is stored in `/src/data/roadmaps/frontend/frontend.md`.
...
```tsx:CommandMenu.tsx {9-13, 15-22}
