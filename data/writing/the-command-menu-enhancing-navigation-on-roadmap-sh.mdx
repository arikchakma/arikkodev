...
You can check out the full source code in the [GitHub](https://github.com/kamranahmedse/developer-roadmap/blob/master/src/components/CommandMenu/CommandMenu.tsx).
