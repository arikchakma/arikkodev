...
export function InvalidateButton(props: InvalidateButtonProps) {
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className="group flex shrink-0 items-center gap-2 rounded-lg bg-black px-3 py-1.5 pl-2 text-sm font-medium text-zinc-50 transition hover:bg-zinc-800 active:translate-y-px"
    >
      <svg
        viewBox="0 0 12 12"
