...
I was able to build a tiny version of Vercel with Rust and AWS. I learned a lot while building this. I am planning to _**open-source**_ the project soon. I will share the link once it's open-sourced.

there are a lot of room for improvement in the project. I will keep working on it and make it better. Please [let me know](https://x.com/imarikchakma) if you have any suggestions or feedback.
