  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap items-center border-b p-6 text-lg dark:border-gray-700">
        ...
        {type !== 'quoted' ? (
          <a href={tweetUrl} className="ml-auto block text-blue-400">
      ...
      {linkPreview ? (
        <div className="shadow-surface-elevation-low mx-6 mt-4 rounded-xl bg-white/[2%] p-3">
      ...
      {!type ? (
        <div className="m-6 mt-4 flex text-white">
          ...
          >
            <svg
              className="mr-3 h-5 w-5 text-black dark:text-white "
              viewBox="0 0 24 24"
            >
              <path
